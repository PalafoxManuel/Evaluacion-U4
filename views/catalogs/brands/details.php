    ...
    if (isset($_SESSION["user_id"]) && $_SESSION['user_id']!=null) {
        if (isset($_GET['id'])){
            ...
            $response = json_decode(json_encode($controlador->getBrandById($id)));
            if ($response->success) {
                $brand = $response->data;
                //var_dump($brand);
            }else{
        ...
        <div class="pc-content">
            ...
            <div class="page-block">
                ...
                <div class="col-md-12">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Detalles de marcas</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                    <h2 class="mb-0">Detalles de marcas</h2>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-lg-5 col-xxl-3">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <p class="mb-0 text-muted me-1">Nombre de la marca</p>
                        <p class="mb-0"><?= $brand->name ?? " " ?></p>
                        </div>
                        <div class="d-inline-flex align-items-center justify-content-between w-100 mb-3">
                        <p class="mb-0 text-muted me-1">Slug</p>
                        <p class="mb-0"><?= $brand->slug ?? " " ?></p>
                        </div>
                    </div>
                    </div>
                </div>
