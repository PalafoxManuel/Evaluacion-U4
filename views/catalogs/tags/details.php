<?php 
  ...
  if (isset($_SESSION["user_id"]) && $_SESSION['user_id']!=null) {
      if (isset($_GET['id'])){
          ...
          $response = json_decode(json_encode($controlador->getTagById($id)));
          if ($response->success) {
              $tag = $response->data;
          }else{
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Detalles de tags</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Detalles de tags</h2>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card overflow-hidden">
                  ...
                  >
                    <a
                      ...
                      aria-selected="true"
                    >
                      <span class="f-w-500"><i class="ph-duotone ph-user-circle m-r-10"></i>Visualización de tag</span>
                    </a>
                  </div>
                </div>
                <div class="card">
                  ...
                  <div class="card-body position-relative">
                    <div class="d-inline-flex align-items-center justify-content-between w-100 mb-3">
                      <p class="mb-0 text-muted me-1">Nombre del tag</p>
