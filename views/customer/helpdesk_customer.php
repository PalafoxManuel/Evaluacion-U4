    ...
    <head>
        <title>Customers | Light Able Admin & Dashboard Template</title>
        <!-- [Meta] -->
        <meta charset="utf-8" />
            ...
            <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                ...
                <li class="list-group-item">
                    ...
                    <div class="flex-grow-1 mx-3">
                        ...
                        <a class="link-primary" href="mailto:sophia.martinez@domain.com">sophia.martinez@domain.com</a>
                    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body shadow border-0">
                    ...
                    <table id="report-table" class="table table-bordered table-striped mb-0">
                        ...
                        <tr>
                            <td>Olivia Garcia</td>
                            <td><a href="#" class="link-secondary">olivia.garcia@outlook.com</a></td>
                            <td>N/A</td>
                            <td>May 25, 2023 at 08:40 AM</td>
                            <td>
                        ...
                        <tr>
                            <td>Robert Brown</td>
                            <td><a href="#" class="link-secondary">robert.brown@company.org</a></td>
                            <td>N/A</td>
                            <td>June 12, 2020 at 11:50 AM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>Sarah Wilson</td>
                            <td><a href="#" class="link-secondary">sarah.wilson@webmail.com</a></td>
                            <td>N/A</td>
                            <td>April 27, 2022 at 03:15 PM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="link-secondary">david.thompson@gmail.com</a></td>
                            <td>N/A</td>
                            <td>February 03, 2024 at 01:25 PM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>Alice Cooper</td>
                            <td><a href="#" class="link-secondary">alice.cooper@domain.com</a></td>
                            <td>Active</td>
                            <td>July 18, 2021 at 10:30 AM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>Chris Martin</td>
                            <td><a href="#" class="link-secondary">chris.martin@example.org</a></td>
                            <td>Inactive</td>
                            <td>December 05, 2022 at 06:15 PM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>Emily Davis</td>
                            <td><a href="#" class="link-secondary">emily.davis@outlook.com</a></td>
                            <td>Suspended</td>
                            <td>November 11, 2020 at 04:30 PM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="link-secondary">michael.johnson@company.com</a></td>
                            <td>Active</td>
                            <td>August 22, 2021 at 09:00 AM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>Jane Smith</td>
                            <td><a href="#" class="link-secondary">jane.smith@mail.com</a></td>
                            <td>Pending</td>
                            <td>JMarch 10, 2023 at 02:45 PM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
                        ...
                        <tr>
                            <td>John Doe</td>
                            <td><a href="#" class="link-secondary">john.doe@example.com</a></td>
                            <td>Active</td>
                            <td>February 15, 2022 at 11:20 AM</td>
                            <td>
                            <a href="#" class="btn btn-sm btn-light-success me-1"><i class="feather icon-edit"></i></a>
                            <a href="#" class="btn btn-sm btn-light-danger"><i class="feather icon-trash-2"></i></a>
                            </td>
