          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div id="categories-section">
                    ...
                    <button type="button" id="add-category" class="btn btn-outline-primary my-2">Añadir</button>
                    ...
                    <button type="button" id="add-tag" class="btn btn-outline-primary my-2">Añadir</button>
            ...
            <div class="col-xl-6">
              <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-0">
                     <p><span class="text-danger">*</span> Resolución sugerida de 645 x 645 para la imagen del producto</p>
                    ...
                    <label class="btn btn-outline-secondary my-2" for="flupld">
                      <i class="ti ti-upload me-2"></i> Haz click para subir
                    </label>
