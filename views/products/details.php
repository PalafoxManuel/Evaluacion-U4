                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="offer-check border rounded p-3">
                          <div class="form-check">
                            ...
                            <label class="form-check-label d-block" for="customCheckdef2">
                              ...
                              <span class="text-muted offer-details"
                                > Descuento de hasta ₹1,250.00 en tarjetas de crédito seleccionadas. Ahorro de hasta ₹2,322.51 en intereses de EMI con tarjetas de crédito 
                                seleccionadas.</span
                              >
                              <span class="h6 mb-0 text-primary">1 Oferta<i class="ti ti-arrow-narrow-right"></i></span>
                            </label>
                        ...
                        <div class="offer-check border rounded p-3">
                          <div class="form-check">
                            ...
                            <label class="form-check-label d-block" for="customCheckdef4">
                              <span class="h6 mb-0 d-block">Oferta Bancaria</span>
                              <span class="text-muted offer-details"
                                > Descuento de hasta ₹1,250.00 en tarjetas de crédito seleccionadas. Ahorro de hasta ₹2,322.51 en intereses de EMI con tarjetas de crédito seleccionadas.
                                </span></span
                              >
                              <span class="h6 mb-0 text-primary">1 Oferta <i class="ti ti-arrow-narrow-right"></i></span>
                            </label>
                      ...
                      <h5 class="mt-4 mb-sm-3 mb-2 f-w-500">Detalle del producto</h5>
                      <ul>
